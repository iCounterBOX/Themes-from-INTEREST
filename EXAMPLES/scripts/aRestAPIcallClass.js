...
/*
' **************  CoreRequest / GET THE WCF Data ****************************************************************
'
' this api is needed To get MassData e.g TmTm  CELL Hack
' VS :   http://localhost:53376/

*/
restApiClass.prototype.makeCorsRequest_WCFquery2DB = function (sqlString) {
        
    //var url = "http://localhost:81/Service2.svc/GetSqlData?sqlQuery='Hallo World'";
	//var url = "http://localhost:53376/IServiceWCF4MSsql/GetSqlData?sqlQuery=Hallo";  // gab 404 und ewig langer page text
    
	var url = "http://localhost:53376/Service2.svc/GetSqlData('Hallo World')";

    console.log("makeCorsRequest_WCFquery2DB() / url= " + url);
    ...
    xhr.onload = function () {
        ...
        console.log("Statistics:/ makeCorsRequest4TrilaterationData(minutes) /totalNrdeliveredCIs= " + text.length);
